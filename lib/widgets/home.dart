            ...
            child: IntrinsicWidth(
              child: TextButton(
                onPressed: () async {
                  ...
                  var libraryDetails = await libraryCollection.findOne({'register_number': registerNumber});

                  if (libraryDetails != null) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Library(details: libraryDetails)),
                    );
                  } else {
            ...
            child: IntrinsicWidth(
              child: TextButton(
                onPressed: () async {
                  ...
                  var busDetails = await busCollection.findOne({'register_number': registerNumber});

                  if (busDetails != null) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Office(details: busDetails)),
                    );
                  } else {
                    print('No details found for the given register number.');
                  }
                },
                child: Text(
                  "View Profile",
